 class GenericLinkedListT<T extends Comparable<T>>
    {
        private Node root;
        private int size;
        ...
        public GenericLinkedListT copyList()     // Копирование списка
        {
            GenericLinkedListT<T> copyList = new GenericLinkedListT<>();
            Node currentNode = root;
